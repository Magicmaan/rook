...
use crate::common::action::{Action, Search};
...
pub struct KeybindSettings {
    pub keybinds: HashMap<Vec<KeyEvent>, Action>,
}
...
impl Default for KeybindSettings {
    fn default() -> Self {
        ...
        keybinds.insert(
            vec![KeyEvent::new(Char('q'), KeyModifiers::CONTROL)],
            Action::Quit,
        );
        // keybinds.insert(
        //     vec![KeyEvent::new(Char(' '), KeyModifiers::NONE)],
